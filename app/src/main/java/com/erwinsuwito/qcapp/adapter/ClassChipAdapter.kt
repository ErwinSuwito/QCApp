...
class ClassChipAdapter(private val context: Context, private val dataset: List<Classroom>, private val onClick: (Classroom) -> Unit)
    : ListAdapter<Classroom, ClassChipAdapter.ItemViewHolder>(classItemDiffCallback)
{
